...
32. [**Login with Chrome SSH Extension** (`chromessh`)](chromessh/README.md)
...
34. [**Understand Basic Algebra Math** (`math`)](math/README.md)
...
35. [**Attain the Forest in CodeCombat.com** (`forest`)](forest/README.md)
36. [**Configure GitHub Keys** (`keys`)](keys/README.md)
...
37. [**Create Your Individual Development Plan (IDP)** (`idp`)](idp/README.md)
...
38. [**Get Verified** (`verify`)](verify/README.md)
39. [**Prep Projects** (`pproj`)](pproj/README.md)
40. [**🍎 Welcome Teachers!** (`teachers`)](teachers/README.md)
