...
32. [**Choosing a Computer** (`computer`)](computer/README.md)
...
33. [**Login with Mac Terminal** (`terminal`)](terminal/README.md)
...
34. [**Login with Chrome SSH Extension** (`chromessh`)](chromessh/README.md)
...
35. [**Command Line Essentials** (`cli`)](cli/README.md)
...
36. [**Understand Basic Algebra Math** (`math`)](math/README.md)
...
37. [**Attain the Desert in CodeCombat.com** (`desert`)](desert/README.md)
38. [**Configure GitHub Keys** (`keys`)](keys/README.md)
...
39. [**Create Your Individual Development Plan (IDP)** (`idp`)](idp/README.md)
...
40. [**Get Verified** (`verify`)](verify/README.md)
41. [**Prep Projects** (`pproj`)](pproj/README.md)
42. [**🍎 Welcome Teachers!** (`teachers`)](teachers/README.md)
