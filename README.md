...
9. [**Complete the Markdown Tutorial** (`markdown`)](markdown/README.md)
10. [**Understand Core Offerings** (`offerings`)](offerings/README.md)
...
11. [**Pick a Path** (`path`)](path/README.md)
  1. [**Python**](path/README.md#user-content--python)
  2. [**Web**](path/README.md#user-content--web)
12. [**Create CodeCombat.com Account(s)** (`codecombat`)](codecombat/README.md)
...
13. [**Remember Passwords!** (`passwords`)](passwords/README.md)
...
14. [**Know Your Web Sites** (`websites`)](websites/README.md)
...
15. [**Agree to Policies** (`policies`)](policies/README.md)
...
16. [**Understand Communications** (`communications`)](communications/README.md)
...
17. [**Sign Student Pledge** (`pledge`)](pledge/README.md)
...
18. [**Attain 24 Words Per Minute Typing** (`typing`)](typing/README.md)
  1. [**Do I have to do home-row typing?**](typing/README.md#user-content--do-i-have-to-do-home-row-typing)
19. [**Toggle Applications with One Hand** (`toggle`)](toggle/README.md)
20. [**Close a Window** (`closewin`)](closewin/README.md)
21. [**Close an Application** (`closeapp`)](closeapp/README.md)
22. [**Take Some Screenshots** (`screenshot`)](screenshot/README.md)
...
23. [**Edit a File with GitHub** (`edit`)](edit/README.md)
24. [**Create First GitHub Issue** (`issues`)](issues/README.md)
25. [**Create Custom Issue Labels** (`labels`)](labels/README.md)
26. [**Dragging a File Into a GitHub Repo** (`upload`)](upload/README.md)
  1. [**File Name Caution**](upload/README.md#user-content--file-name-caution)
27. [**Learn to Learn, Just in Time** (`jit`)](jit/README.md)
28. [**What is Coding?** (`what`)](what/README.md)
...
29. [**Organic Learning** (`organic`)](organic/README.md)
  1. [**Learning is Messy**](organic/README.md#user-content--learning-is-messy)
30. [**Learning to Mastery** (`mastery`)](mastery/README.md)
...
31. [**Choosing a Computer** (`computer`)](computer/README.md)
...
32. [**Login with Mac Terminal** (`terminal`)](terminal/README.md)
...
33. [**Login with Chrome SSH Extension** (`chromessh`)](chromessh/README.md)
...
34. [**Command Line Essentials** (`cli`)](cli/README.md)
...
35. [**Understand Basic Algebra Math** (`math`)](math/README.md)
...
36. [**Attain the Forest in CodeCombat.com** (`forest`)](forest/README.md)
37. [**Configure GitHub Keys** (`keys`)](keys/README.md)
...
38. [**Create Your Individual Development Plan (IDP)** (`idp`)](idp/README.md)
...
39. [**Get Verified** (`verify`)](verify/README.md)
40. [**Prep Projects** (`pproj`)](pproj/README.md)
41. [**🍎 Welcome Teachers!** (`teachers`)](teachers/README.md)
