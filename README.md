...
3. [**Pick a Screen Name** (`screenname`)](screenname/README.md)
  1. [**Be Creative**](screenname/README.md#user-content--be-creative)
  2. [**Anonymous If You Wish**](screenname/README.md#user-content--anonymous-if-you-wish)
  3. [**All Lowercase**](screenname/README.md#user-content--all-lowercase)
  4. [**At Least Three Characters**](screenname/README.md#user-content--at-least-three-characters)
  5. [**Handling Duplicates**](screenname/README.md#user-content--handling-duplicates)
...
5. [**Google Chrome Web Browser** (`chrome`)](chrome/README.md)
  ...
  2. [**Use Chrome Incognito**](chrome/README.md#user-content--use-chrome-incognito)
6. [**Join Mailing List** (`mailing`)](mailing/README.md)
...
7. [**Create Google Gmail Account** (`gmail`)](gmail/README.md)
  1. [**Under 13**](gmail/README.md#user-content--under-13)
  2. [**13 and Up**](gmail/README.md#user-content--13-and-up)
  3. [**Your Most Important Password**](gmail/README.md#user-content--your-most-important-password)
  4. [**Multiple Gmail Accounts**](gmail/README.md#user-content--multiple-gmail-accounts)
8. [**Join the Slack Chat Room** (`slack`)](slack/README.md)
...
9. [**Create GitHub Account** (`github`)](github/README.md)
  ...
  2. [**Sign Up**](github/README.md#user-content--sign-up)
  3. [**Pick a Lowercase Screen Name**](github/README.md#user-content--pick-a-lowercase-screen-name)
  4. [**Select the Free Plan**](github/README.md#user-content--select-the-free-plan)
  5. [**Skip the Survey**](github/README.md#user-content--skip-the-survey)
  6. [**Start a Project**](github/README.md#user-content--start-a-project)
  7. [**Verify you Email Address**](github/README.md#user-content--verify-you-email-address)
  8. [**Find the Email**](github/README.md#user-content--find-the-email)
  9. [**Create a New Repository**](github/README.md#user-content--create-a-new-repository)
  10. [**Create a README**](github/README.md#user-content--create-a-readme)
  11. [**Change the Name and Edit**](github/README.md#user-content--change-the-name-and-edit)
  12. [**Commit New File**](github/README.md#user-content--commit-new-file)
  13. [**Change Your Profile Icon**](github/README.md#user-content--change-your-profile-icon)
  14. [**The Rest of Your Profile**](github/README.md#user-content--the-rest-of-your-profile)
...
13. [**Create CodeCombat.com Account(s)** (`codecombat`)](codecombat/README.md)
  1. [**Overview**](codecombat/README.md#user-content--overview)
  2. [**Select “Play Now”**](codecombat/README.md#user-content--select-play-now)
  3. [**Select “Sign Up”**](codecombat/README.md#user-content--select-sign-up)
  4. [**“Sign up as an individual”**](codecombat/README.md#user-content--sign-up-as-an-individual)
  5. [**Decide Birthday to Use**](codecombat/README.md#user-content--decide-birthday-to-use)
  6. [**Do NOT Connect with Facebook or Google!**](codecombat/README.md#user-content--do-not-connect-with-facebook-or-google)
  7. [**Create Two Accounts**](codecombat/README.md#user-content--create-two-accounts)
  8. [**Repeat**](codecombat/README.md#user-content--repeat)
  9. [**“Start Playing”**](codecombat/README.md#user-content--start-playing)
  10. [**Start the Dungeon**](codecombat/README.md#user-content--start-the-dungeon)
14. [**Remember Passwords!** (`passwords`)](passwords/README.md)
  1. [**Strategies**](passwords/README.md#user-content--strategies)
  2. [**Never Use “Remember/Save Password”**](passwords/README.md#user-content--never-use-remembersave-password)
  3. [**Google Password Recovery**](passwords/README.md#user-content--google-password-recovery)
15. [**Know Your Web Sites** (`websites`)](websites/README.md)
...
16. [**Agree to Policies** (`policies`)](policies/README.md)
...
17. [**Understand Communications** (`communications`)](communications/README.md)
...
18. [**Sign Student Pledge** (`pledge`)](pledge/README.md)
...
19. [**Attain 24 Words Per Minute Typing** (`typing`)](typing/README.md)
  1. [**Do I have to do home-row typing?**](typing/README.md#user-content--do-i-have-to-do-home-row-typing)
20. [**Toggle Applications with One Hand** (`toggle`)](toggle/README.md)
21. [**Close a Window** (`closewin`)](closewin/README.md)
22. [**Close an Application** (`closeapp`)](closeapp/README.md)
23. [**Take Some Screenshots** (`screenshot`)](screenshot/README.md)
...
24. [**Edit a File with GitHub** (`edit`)](edit/README.md)
25. [**Create First GitHub Issue** (`issues`)](issues/README.md)
26. [**Create Custom Issue Labels** (`labels`)](labels/README.md)
27. [**Dragging a File Into a GitHub Repo** (`upload`)](upload/README.md)
  1. [**File Name Caution**](upload/README.md#user-content--file-name-caution)
28. [**Learn to Learn, Just in Time** (`jit`)](jit/README.md)
29. [**What is Coding?** (`what`)](what/README.md)
...
30. [**Organic Learning** (`organic`)](organic/README.md)
  1. [**Learning is Messy**](organic/README.md#user-content--learning-is-messy)
31. [**Learning to Mastery** (`mastery`)](mastery/README.md)
...
32. [**Understand Athletic Software Engineering** (`athletic`)](athletic/README.md)
33. [**Choosing a Computer** (`computer`)](computer/README.md)
...
34. [**Login with Mac Terminal** (`terminal`)](terminal/README.md)
...
35. [**Login with Chrome SSH Extension** (`chromessh`)](chromessh/README.md)
  1. [**First Login to Chrome**](chromessh/README.md#user-content--first-login-to-chrome)
  2. [**Install the Extension**](chromessh/README.md#user-content--install-the-extension)
  3. [**Download the Solarized Theme Configuration**](chromessh/README.md#user-content--download-the-solarized-theme-configuration)
  4. [**“Restore Backup” to Update for Solarized Theme**](chromessh/README.md#user-content--restore-backup-to-update-for-solarized-theme)
  5. [**Configure and Connect**](chromessh/README.md#user-content--configure-and-connect)
  6. [**Do Not Forget to Logout of Chrome!**](chromessh/README.md#user-content--do-not-forget-to-logout-of-chrome)
  7. [**Removing the Chrome SSH Extension**](chromessh/README.md#user-content--removing-the-chrome-ssh-extension)
36. [**Command Line Essentials** (`cli`)](cli/README.md)
...
38. [**Attain the Desert in CodeCombat.com** (`desert`)](desert/README.md)
39. [**Configure GitHub Keys** (`keys`)](keys/README.md)
...
40. [**Create Your Individual Development Plan (IDP)** (`idp`)](idp/README.md)
...
41. [**Get Verified** (`verify`)](verify/README.md)
42. [**Prep Projects** (`pproj`)](pproj/README.md)
43. [**🍎 Welcome Teachers!** (`teachers`)](teachers/README.md)
